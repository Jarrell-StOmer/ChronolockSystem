...
# Enter LED pin
Relay = 27
#Setting relay state to False because the relay is normally closed rather than normally open
relayState = False
...
#Relay set to low so that it is normally closed rather than normally open
